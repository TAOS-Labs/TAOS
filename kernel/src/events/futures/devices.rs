...
use crate::{devices::sd_card::{PresentState, SDCardError}, events::{runner_timestamp, Event}};
...
impl Future for SDCardReq {
    ...
    fn poll(self: Pin<&mut Self>, _: &mut Context<'_>) -> Poll<Self::Output> {
        ...
        let present_state = unsafe {
          PresentState::from_bits_retain(core::ptr::read_volatile(self.present_state_register_addr))
        };
