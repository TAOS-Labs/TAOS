...
mod tests {
    ...
    use crate::{
        constants::processes::{TEST_EXIT_CODE, TEST_SIMPLE_PROCESS},
        events::{
            current_running_event, futures::await_on::AwaitProcess, get_runner_time, schedule_process, schedule_process_on, yield_now
        },
    ...
    async fn test_simple_process() {
        ...
        assert!(waiter.is_ok(), "Waiter is not okay");
    }
